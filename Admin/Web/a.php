...
<head>
    ...
    <!-- Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">    <!-- Bootstrap JS -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>    <title>Admin Pesan Palgading</title>
        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
                ...
                <div class="col py-3">
                            ...
                            <tr>
                                <?php 
                                    ...
                                    if($stmt->num_rows > 0){
                                        ...
                                        $stmt->fetch();
                                        ?> <th class="table-dark" colspan=<?php print $colspan ?>>Pesanan Baru</th>
                                        <?php
                                    }
                    ...
                    <!-- Table Location -->
                    <div class="rowCustom marginTable">
                        <table class="table table-bordered border-dark" style="max-width: 500px;">
                            <!--  //| Lokasi Meja  -->
                            <!-- //* If Nomor Meja is clicked then show the Select Order on the next Table -->
                            <tr>
                            
                                <th class="table-dark" colspan="5" scope="colgroup" >Lokasi Meja</th>
                            </tr>
                            <tr>
                                <?php 
                                ...
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td colspan="2" style="height: 50px; font-size:30px;" style="background-color: <?php echo $table1Status ?>;" >
                                        <form method="POST" action="a.php" class="hiddenform">
                                ...
                                <tr class="sizetables1">
                                    <td style="background-color: <?php echo $table12Status ?>;">
                                        <form method="POST" action="a.php" class="hiddenform">
                    ...
                    <div>
                        <div class="rowCustom marginTable">
                                ...
                                <div class="columnCustom" >
                                    <table class="table table-bordered border-dark table-striped table-hover" style="text-align: center;">
                                        <tr>
                                            <tr>
                                                <th class= "table-dark" colspan="8" >Detail Order</th>
                                            </tr>
                                            <tr>
                                                <th>Lokasi</th>
