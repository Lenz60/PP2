    ...
    <body>
        <fieldset>
            ...
            $classS = 'show';
                ...
                <form action="mergedtable.php" method="POST">
        ...
        <!-- Incoming Table -->
        <div >
            <table class="table table-bordered border-dark" style="max-width:50px;">
                <?php 
                include("connect.php");
                $notable = 0;
                ?>
                    ...
                    <?php
                        ...
                        while ($rowIncoming = $resultIncomingOrder -> fetch_array(MYSQLI_ASSOC)){
                            ...
                            <td class="sizetables3">
                                <form method="POST" action="mergedtable.php" class="hiddenform">
        ...
        <!-- Table Detail Order -->
            ...
            <div class="row">
                    <!-- Table Detail Order -->
                    <div class="column">
                        <table class="table table-bordered border-dark text-center" style="max-width:70%;">
                            <tr>
                                <?php
                                    include("connect.php");
                                ?>
