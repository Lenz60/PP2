...
CREATE TABLE `product` (
  ...
  `Tipe_produk` enum('Goreng','Kuah','Pedas','Manis','Bakso','Urat','Halus','Campur','Es','Hot','Soto','Jajanan','Promo') DEFAULT NULL,
...
('PROMO1', 'Promo', 'Promo', 'Promo 1 (Mie Ayam + Esteh)', 12000),
('PROMO2', 'Promo', 'Promo', 'Promo 2 (Bakso + Esteh)', 15000),
('PROMO3', 'Promo', 'Promo', 'Promo 3 (Soto Ayam + Esteh)', 11000),
...
--
ALTER TABLE `guest_order`
  MODIFY `Kode_guest_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=281;

--
-- AUTO_INCREMENT for table `product_order`
--
ALTER TABLE `product_order`
  MODIFY `Kode_produk_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=264;
...
--
ALTER TABLE `topping_order`
  MODIFY `Kode_topping_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=427;
