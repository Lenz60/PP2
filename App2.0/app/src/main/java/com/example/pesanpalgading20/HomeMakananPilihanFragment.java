...
public class HomeMakananPilihanFragment extends Fragment {
    ...
    LinearLayout ContainerContentPilihanMenu;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ContainerContentPilihanMenu = viewRoot.findViewById(R.id.ContainerContentPilihanMenu);

        ImageViewPilihanMieayam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ContainerContentPilihanMenu.setVisibility(View.GONE);
                ...
                transaction.replace(R.id.ContainerPilihanMenu, FragmentMakananMieayam);
        ...
        ImageViewPilihanBaksoKuah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Replace whatever is in the fragment_container view with this fragment,
                // and add the transaction to the back stack
                transaction.replace(R.id.ContainerPilihanMenu, FragmentMakananBakso);
                transaction.addToBackStack(null);
                // Commit the transaction
                transaction.commit();
            }
        ...
        ImageViewPilihanBaksoBakar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Replace whatever is in the fragment_container view with this fragment,
                // and add the transaction to the back stack
                transaction.replace(R.id.ContainerPilihanMenu, FragmentMakananBaksoBakar);
                transaction.addToBackStack(null);
                // Commit the transaction
                transaction.commit();
            }
        ...
        ImageViewPilihanSoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Replace whatever is in the fragment_container view with this fragment,
                // and add the transaction to the back stack
                transaction.replace(R.id.ContainerPilihanMenu, FragmentMakananSoto);
                transaction.addToBackStack(null);
                // Commit the transaction
                transaction.commit();
            }
